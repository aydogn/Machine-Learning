...
# sns.countplot(data["class"]) #abnormal ve normal olmak üzere 2 adet sınıf
# plt.show()
...
#veri hakkında bilgi
data.info() #hepsinin sayısal veriler olduğunu gördük

y = data["class"].values 
x_data = data.drop(["class"],axis=1) #drop fonksiyonu verilen satır(axis=0),
# stünu(axis=1) veriden çıkarmaya yarar.

#verinin içerisinde bulunan özelliklerin birbiri ile ilişkisini yorumlama
#verilerin numerik olduğuna dikkat et
# sns.pairplot(x_data)
# plt.show()
